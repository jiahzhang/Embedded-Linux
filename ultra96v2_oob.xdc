...
# ------------------------- User LEDs  --------------------------------------------------
#
set_property PACKAGE_PIN AA3  [get_ports {user_led[3]          }];  # "AA3.MIO17_PS_LED3"
set_property PACKAGE_PIN Y5   [get_ports {user_led[2]          }];  # "Y5.MIO18_PS_LED2"
set_property PACKAGE_PIN AA4  [get_ports {user_led[1]          }];  # "AA4.MIO19_PS_LED1"
set_property PACKAGE_PIN AB4  [get_ports {user_led[0]          }];  # "AB4.MIO20_PS_LED0"

# User Push Button
set_property PACKAGE_PIN AB5  [get_ports {user_button          }];  # "AB5.MIO23_GPIO_PB"
